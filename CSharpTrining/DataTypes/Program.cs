...
class Program
{
    ...
    {
          byte by = 49;//this is byte it can store  0-255 number 
        Byte By = 4;
        Console.WriteLine(by + " " + By);
          short sh = (short)(by + by);//short sh =(short) by; we can store directly bu lower data can not add and store
        Int16 Sh = (Int16)by;
        ...
        Console.WriteLine(fl);
            double db = 14.254915424554521556;//13 positions
        Double Db = 4.254915424554521556;
        Console.WriteLine($"{db} Db");
             long lo = 4484848645454534;
